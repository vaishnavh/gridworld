png('plot_C_return.png',width=1200,height=700,pointsize=20)
...
legend(x=400,y=0.0,col=c("darkblue","black","gray8","gray29","gray40","gray60","gray73"),cex=1,
       legend=c("Q","S(0)","S(0.3)","S(0.5)","S(0.9)","S(0.99)","S(1)"),lwd=2)
dev.off()

png('plot_C_steps.png',width=1200,height=700,pointsize=20)
...
legend(x=400,y=1500,col=c("darkblue","black","gray8","gray29","gray40","gray60","gray73"),
       legend=c("Q","S(0)","S(0.3)","S(0.5)","S(0.9)","S(0.99)","S(1)"),lwd=2)
dev.off()
